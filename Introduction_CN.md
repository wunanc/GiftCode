...
## 📥 安装指南
1. 前往 [Releases](https://github.com/WunancStudio/GiftCode/releases/latest) 页面下载最新版本的 `GiftCode-x.x.x.jar`。
...
本项目采用 MIT 许可证，详见 [LICENSE](https://github.com/WunancStudio/GiftCode/blob/master/LICENSE) 文件。
